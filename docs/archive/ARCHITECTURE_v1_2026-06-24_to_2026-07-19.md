...
> ## 🗄️ Archived: ARCHITECTURE v1
> **Covers:** 2026-06-24 → 2026-07-19  
> **Describes:** Phase 1 only — raw-material inward (PO upload, AI extraction, confirm gate, per-unit QR, receiving).  
> **Why archived:** Superseded by v2 when Phase 2 (requests + stock ledger) and Phase 3 (finished goods + dispatch) landed. Kept because it records the original invariants I1-I9 and the Phase 1 module map as first designed.  
